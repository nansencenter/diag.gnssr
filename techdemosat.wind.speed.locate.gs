...
*
*     grads -blc "techdemosat.wind.speed.locate gnss.tds1.txt.all.locate"
*
* - RD November 2012
...
*   if (cycnum >  10000) ; cyccol = 14 ; endif
    if (cycnum > 4) ; cyccol = 14 ; endif
    if (cycnum = 4) ; cyccol = 13 ; endif
    if (cycnum = 3) ; cyccol = 10 ; endif
    if (cycnum = 2) ; cyccol = 12 ; endif
...
obsx = refx+1.3 ; obsy = refy+0.2 ; "set line 12" ; "draw mark 3 "obsx" "obsy" "dotsiz ; "draw string "obsx+0.1" "obsy" =2"
obsx = refx+2.4 ; obsy = refy+0.2 ; "set line 10" ; "draw mark 3 "obsx" "obsy" "dotsiz ; "draw string "obsx+0.1" "obsy" =3"
obsx = refx+0.6 ; obsy = refy-0.2 ; "set line 13" ; "draw mark 3 "obsx" "obsy" "dotsiz ; "draw string "obsx+0.1" "obsy" =4"
obsx = refx+1.9 ; obsy = refy-0.2 ; "set line 14" ; "draw mark 3 "obsx" "obsy" "dotsiz ; "draw string "obsx+0.1" "obsy" >4"
...
say "gxprint plot.techdemosat.wind.speed.dots."dotfile".png png white x1100 y850"
    "gxprint plot.techdemosat.wind.speed.dots."dotfile".png png white x1100 y850"
"quit"
